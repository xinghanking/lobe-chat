          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'NewtonAI is an AI conversation application built with the Next.js framework. I will help you write the development documentation for NewtonAI.',
                tags: [
                ...
                title: 'NewtonAI Technical Documentation Expert',
              },
              type: 'agent',
